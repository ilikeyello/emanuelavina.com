      ...
      <main className="flex-grow flex flex-col items-center justify-center text-center px-4">
        <div className="max-w-3xl">
          ...
          <div className="mt-12 flex justify-center gap-4">
            ...
            <Link href="/dashboard" className="px-8 py-4 border border-gray-300 text-gray-800 text-lg font-semibold rounded-md hover:bg-gray-100 transition-transform transform hover:scale-105">
              Client Login
            </Link>
          </div>
        </div>
